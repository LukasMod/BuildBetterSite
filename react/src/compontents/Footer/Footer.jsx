        ...
        <footer className={style()}>
            <section className={style('contact-wrapper')}>
                <div className={style('media-wrapper')}>
                    <a href={linkToGitHub}><FontAwesomeIcon icon={['fab', 'facebook-square']} className={style('media')} /></a>
                    <a href={linkToGitHub}><FontAwesomeIcon icon={['fab', 'github-square']} className={style('media')} /></a>
                    <a href={linkToGitHub}><FontAwesomeIcon icon={'envelope-square'} className={style('media')} /></a>
                </div>
                <address className={style('address-wrapper')}>
                    <div>
                        <FontAwesomeIcon icon={'building'} className={style('media--small')} />
                        <span>Gdynia, Świętokrzyska 1</span>
                    </div>
                    <div>
                        <FontAwesomeIcon icon={'phone-square-alt'} className={style('media--small')} />
